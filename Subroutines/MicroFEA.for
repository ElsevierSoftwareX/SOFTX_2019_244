...
!                  Accepts up to three different Materials
!     ------------------------------------------------------------------
...
!      P = PROPS(24)
      ...
      E_MAT = 179.4D9				  ! Matrix Elastic Modulus (Pa)
      E_INC = 151.0D9				  ! Inclusion's Elastic Modulus (Pa)
      NU_MAT = 0.37D0			      ! Matrix Poisson's Ratio
      NU_INC = 0.38D0     			  ! Inclusion's Poisson's Ratio	  
